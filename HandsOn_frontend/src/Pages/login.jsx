...
const Login = () => {
  return (
    <div className="py-50 bg-blue-100">
      <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <div className="w-full p-8 lg:w-1/2">
          <h2 className="text-2xl font-semibold text-blue-800 text-center">HandsOn</h2>
          <p className="text-xl text-blue-600 text-center">Welcome back!</p>
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <a href="#" className="text-xs text-blue-500 uppercase">or sign up</a>
            <span className="border-b w-1/5 md:w-1/4"></span>
          </div>
        </div>
      </div>
